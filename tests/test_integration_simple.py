...
class TestSimpleIntegration:
    ...
    @pytest.mark.asyncio
    async def test_agent_integration_with_mocks(self, integration_config, mock_llm_client, mock_mcp_manager):
    ...
    def test_config_validation_integration(self):
        ...
        with pytest.raises(ValueError):
            Config(
                ...
                llm=LLMConfig(provider="invalid", model="test", api_key="test"),  # Invalid provider
                evaluation=EvaluationConfig()
            )
