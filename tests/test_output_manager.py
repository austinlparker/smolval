...
class TestOutputManager:
    ...
    def test_write_comparison_results(self, mock_formatter_class):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            mock_formatter = Mock()
            mock_formatter_class.return_value = mock_formatter
            mock_formatter.format_comparison_results.return_value = (
            ...
            files = manager.write_comparison_results(
                comparison_data, "server_comparison"
            )
    ...
    def test_create_nested_directories(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert run_dir.exists()
            assert (
                run_dir.parent == nested_path
            )  # run_dir is nested_path/timestamp_test
