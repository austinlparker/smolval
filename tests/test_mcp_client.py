...
class TestMCPClientManager:
    ...
    async def test_connect_server_success(self, filesystem_server_config: MCPServerConfig) -> None:
        ...
        with patch('smolval.mcp_client.stdio_client') as mock_stdio_client, \
            ...
            manager.exit_stack.enter_async_context = AsyncMock(side_effect=mock_enter_context)
    ...
    @pytest.mark.asyncio
    async def test_connect_server_tool_discovery_failure(self, filesystem_server_config: MCPServerConfig) -> None:
    ...
    async def test_execute_tool_no_client(self) -> None:
        ...
        with pytest.raises(ValueError, match="No client available for server 'missing_server'"):
    ...
    def test_get_available_tools(self) -> None:
        ...
        # Add some tools
        tool1 = MCPTool(name="tool1", description="Tool 1", input_schema={}, server_name="server1")
        tool2 = MCPTool(name="tool2", description="Tool 2", input_schema={}, server_name="server2")
        ...
        tools.append(MCPTool(name="tool3", description="Tool 3", input_schema={}, server_name="server3"))
    ...
    async def test_close_connections(self) -> None:
        ...
        manager.tools = [MCPTool(name="test", description="test", input_schema={}, server_name="test")]
